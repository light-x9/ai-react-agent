...
const QUESTION_POOL = [
  // 联网调研
  '搜索今天的 AI 领域热点新闻，总结要点',
  '对比 Vue 3 和 React 的核心差异，整理成表格',
  '调研主流 AI 编程工具的优缺点，生成对比报告',
  '今天北京的天气怎么样，适合出去跑步吗',
  // 文件分析 + 导出
  '上传一份 PDF 合同，帮我提取关键条款并总结',
  '把这份产品介绍整理成 Markdown 文档并下载',
  '帮我写一份项目周报，导出 Markdown',
  // 教育场景
  '我想学 Python，帮我制定一个 30 天学习计划',
  '用通俗语言解释什么是 RAG 检索增强生成',
  '推荐 5 本适合入门编程的书，说明理由',
  // 写作 + 办公
  '写一封正式的商务询价邮件',
  '润色这段自我介绍，让它更专业',
